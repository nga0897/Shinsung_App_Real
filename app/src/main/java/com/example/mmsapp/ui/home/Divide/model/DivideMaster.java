...
public class DivideMaster {
    ...
    private int countTable2;

    @SerializedName("het_ca")
    private int endShift;

    public DivideMaster(int idActual, String staffId, String regDt, int wmtId, String date, String mtCd, String mtNo, int grQty, String bbmpStsCd, String mtQrCode, String bbNo, String chgDt, int slTruNg, int countTable2, int endShift) {
    ...
    public int getCountTable2() {
        return countTable2;
    }

    public void setCountTable2(int countTable2) {
        this.countTable2 = countTable2;
    }
